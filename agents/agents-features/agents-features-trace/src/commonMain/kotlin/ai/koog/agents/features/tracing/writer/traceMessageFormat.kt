...
internal val StartLLMStreamingEvent.startLLMStreamingEventFormat
    get() = "$eventId (run id: ${runId}, prompt: ${prompt.traceString}, model: ${model})"
...
internal val AfterExecuteMultipleChoicesEvent.afterExecuteMultipleChoicesEventFormat
    get() = "$eventId (run id: ${runId}, prompt: ${prompt.traceString}, model: ${model}, responses: [${responses.joinToString { response -> "[${response.joinToString { message -> message.traceString }}]" }}])"
