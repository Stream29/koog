package ai.koog.agents.features.opentelemetry.feature.interceptor.context

import io.opentelemetry.context.Context
import java.util.concurrent.atomic.AtomicReference

/**
 * A global registry for OpenTelemetry context that allows sharing context across different threads.
 * This helps ensure that all spans created in different threads can be linked to the same trace.
 */
