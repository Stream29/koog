 ...
 *
 * @property sessionId The unique identifier for the current session. This helps to correlate the operation with a specific session instance.
 ...
 * This data class encapsulates relevant information such as the session identifier, prompt details,
 * model used, tools involved, and the response from the model.
 *
 * @property sessionId A unique identifier for the session where the operation was executed.
