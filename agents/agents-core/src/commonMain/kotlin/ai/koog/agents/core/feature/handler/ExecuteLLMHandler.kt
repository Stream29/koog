...
public class ExecuteLLMHandler {
    ...
    public var beforeLLMCallHandler: BeforeLLMCallHandler =
        BeforeLLMCallHandler { sessionId: String, prompt: Prompt, tools: List<ToolDescriptor>, model: LLModel -> }
    ...
    public var afterLLMCallHandler: AfterLLMCallHandler =
        AfterLLMCallHandler { sessionId: String, prompt: Prompt, tools: List<ToolDescriptor>, model: LLModel, response: List<Message.Response> -> }
