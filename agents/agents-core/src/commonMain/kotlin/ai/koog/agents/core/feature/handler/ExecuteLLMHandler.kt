...
public class ExecuteLLMHandler {
    ...
    public var beforeLLMCallHandler: BeforeLLMCallHandler =
        BeforeLLMCallHandler { sessionId: String, nodeName: String, prompt: Prompt, tools: List<ToolDescriptor>, model: LLModel -> }
    ...
    public var afterLLMCallHandler: AfterLLMCallHandler =
        AfterLLMCallHandler { sessionId: String, nodeName: String, prompt: Prompt, tools: List<ToolDescriptor>, model: LLModel, response: List<Message.Response> -> }

    /**
     * TODO: SD -- ...
     */
    public var startLLMStreamingHandler: StartLLMStreamingHandler =
        StartLLMStreamingHandler { sessionId: String, nodeName: String, prompt: Prompt, model: LLModel -> }
}
...
public fun interface BeforeLLMCallHandler {
     ...
     */
    public suspend fun handle(sessionId: String, nodeName: String, prompt: Prompt, tools: List<ToolDescriptor>, model: LLModel)
}
...
public fun interface AfterLLMCallHandler {
     ...
     */
    public suspend fun handle(sessionId: String, nodeName: String, prompt: Prompt, tools: List<ToolDescriptor>, model: LLModel, responses: List<Message.Response>)
}

public fun interface StartLLMStreamingHandler {
    public suspend fun handle(sessionId: String, nodeName: String, prompt: Prompt, model: LLModel)
}
