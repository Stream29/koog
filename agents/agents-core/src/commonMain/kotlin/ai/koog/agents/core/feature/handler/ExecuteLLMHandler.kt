...
public class ExecuteLLMHandler {
    ...
    public var beforeLLMCallHandler: BeforeLLMCallHandler =
        BeforeLLMCallHandler { prompt, tools, model, sessionId -> }
    ...
    public var afterLLMCallHandler: AfterLLMCallHandler =
        AfterLLMCallHandler { prompt, tools, model, response, sessionId -> }
}
...
public fun interface BeforeLLMCallHandler {
     ...
     */
    public suspend fun handle(prompt: Prompt, tools: List<ToolDescriptor>, model: LLModel, sessionId: String)
}
...
public fun interface AfterLLMCallHandler {
     ...
     * @param sessionId The unique identifier for the session during which the processing takes place.
     */
    public suspend fun handle(prompt: Prompt, tools: List<ToolDescriptor>, model: LLModel, responses: List<Message.Response>, sessionId: String)
}
