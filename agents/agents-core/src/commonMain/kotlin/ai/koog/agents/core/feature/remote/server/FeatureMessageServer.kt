 ...
 *
 * Features:
 *   - Send SSE events [ai.koog.agents.core.feature.message.FeatureMessage] during agent execution, e.g. [ai.koog.agents.core.feature.model.AgentCreateEvent];
...
public interface FeatureMessageServer : Closeable {
     ...
     * send SSE events [ai.koog.agents.core.feature.message.FeatureMessage], and respond to health check requests from clients.
     *
     ...
     *
     * This method is designed to enqueue the given [ai.koog.agents.core.feature.message.FeatureMessage] into a channel, from which
     * it will be serialized and sent to all subscribed clients or receivers, if applicable. The
     * method ensures that the message conforms to the expected [ai.koog.agents.core.feature.message.FeatureMessage] interface.
     *
     * @param message The message to be sent, implementing the [ai.koog.agents.core.feature.message.FeatureMessage] interface. This message
